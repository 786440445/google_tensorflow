...
import numpy as np
import time
import Chapter5.cifar10.cifar10 as cifar10
import Chapter5.cifar10.cifar10_input as cifar10_input
...
with tf.Session() as sess:
    ...
    for step in range(max_steps):
        ...
        if step % 10 == 0:
            ...
            format_str=('step %d, loss=%.2f (%.f examples/sec; %.3f sec/batch)')
    ...
    while step < num_iter:
        ...
        predictions = sess.run([top_k_op], feed_dict={image_holder: images_test, label_holder: labels_test})
